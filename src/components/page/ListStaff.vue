<template>
  <div class="staff">
    <div class="toast-success" :class="!isShowToats? 'hide-toast' : 'show-toast'">Xóa thành công</div>
      ...
      <div class="staff-box h-100">
        <div class="d-flex justify-content-between">
          ...
          <div class="d-flex">
            ...
            <button class="btn btn-sm btn-success mb-3 ms-2" title="Thêm nhân viên" @click="addStaff">Thêm</button>
          </div>
